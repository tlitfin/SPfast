...
1. Clone this repository
    ...
    ```
    git clone https://github.com/tlitfin/SPfast.git
    cd SPfast
    ```
...
1. Install SPlib python library
...
1. Compile SPfast and prepare_bin binaries
...
1. Install DSSP to extract secondary structures labels.
...
# NOTE: how is the example.db made?
# Database format to avoid many small files
./src/prepare_bin.gnu \
    -qlist ./output \
    ./example/example_list .ideal \
    -tdb example.db > example.db.index
...
# Search all-vs-all
./src/SPfast.gnu \
    -qlist ./output ./example/example_list .ideal.bin \
    -tlist ./output ./example/example_list .ideal.bin
